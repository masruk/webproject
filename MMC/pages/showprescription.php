...
<html>
	<head>
        ...
        <link rel="stylesheet" href="../styles/web-fonts-with-css/css/fontawesome-all.min.css" />
        <style rel="stylesheet" type="text/css" >
            #print button{ background: rgba(255, 255, 255, 0.3);color:#0000ff !important;border: none;!important;}
        </style>
	</head>
		...
		<div id="container" style="overflow:hidden;">
			<div class="row">
				<div class="col-md-3" id="prescription-list" style="padding-top:50px;">
					<ul id="prescription-id-list">
						...
						<?php
							...
							if($_SESSION["user_category"]=="admin" && $_SESSION["designation"]=="CC") $sql1="select prescriptionid,prescription_date from medicalrecords a LEFT JOIN students b ON a.patientId=b.studentId  where b.studentId=".$username." AND UPPER(b.department)='".$_SESSION["department"]."'  ORDER BY prescriptionid desc;";
							else   $sql1="select prescriptionid,prescription_date from medicalrecords 
				...
				<div class="col-md-9" style="border-left:1px solid green;">
                    <div id="print"><button  type="button"  onclick="javascript:printPrescription('print_pres')"><i class="fas fa-print fa-2x"></i>print</button></div>
                    <div id="print_pres" style="background: url('../images/mist_logo.png') no-repeat center; background-size: 80% 80%; -webkit-print-color-adjust: exact;">
                        <div id="pres_div" style="margin-top: -30px !important; background-color:rgba(255, 255, 255, 0.9);">
                            <table id="no-bordered-table" style="width:100%; border:none !important; margin-bottom:35px !important;">
                             ...
                             <table id="showprescription" style="width:100%; margin-bottom: 30px; color:#2b71ae;">
                                 <tr>
                                     <td rowspan="7" style="width:60%"><span style="color:#38b25f;font-weight: 600;font-size: 103%;">Deseas: </span><?php echo $medicalrcord["desease"];?></td>
                                     <th style="color:#d9352e;">Date:</th>
                                     <td><?php echo $medicalrcord["prescription_date"]; ?></td></tr>
                                <tr>

                                    <th style="color:#38b25f;">Name:</th>
                                    <td><?php if(!empty($prescribedID)) echo $full_name; ?></td>
                                </tr>
                                 <tr>
                                    <th style="color:#38b25f;">Age:</th>
                                    <td><?php
                                        if(!empty($prescribedID)) {
                            ...
                            <table id="showprescription" align="center" style="width:100%; color:#2b71ae; ">
                                <tr>
                                    ...
                                    <th style="width:20%; color:#38b25f;"></th>
                                    <th style="width:15%; color:#38b25f; "></th>
                                    <th style="width:35%; color:#38b25f;"></th>
    <!--								<th style="width:15%;color:#38b25f;">Issued(pc)</th>-->
                            ...
                            <p  style="text-decoration: overline;margin-top: 90px;">Signature</p>
                        </div>
                    </div>
				</div>
			</div>
    ...
    <script language="javascript" type="text/javascript">
        function printPrescription(divID) {
